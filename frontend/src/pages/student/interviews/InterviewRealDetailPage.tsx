...
import { useInterviewRealDetail } from '@/entities/student-interviews'
...
export function InterviewRealDetailPage() {
  const { interviewId = '' } = useParams()
  const { data, isLoading, isError, error, refetch } = useInterviewRealDetail(interviewId)
